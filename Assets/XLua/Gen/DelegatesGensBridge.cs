...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp8(int p0, int p1, out GameInit.LClass p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                p2 = (GameInit.LClass)translator.GetObject(L, errFunc + 2, typeof(GameInit.LClass));
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(GameInit.Ldelegate))
			{
			    return new GameInit.Ldelegate(__Gen_Delegate_Imp8);
			}
